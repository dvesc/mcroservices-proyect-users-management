...
public interface Users_repository extends JpaRepository<Users_vo, Long> {
  ...
  // Email----------------------------------------------------------------------
  @Query(value = "SELECT * FROM users WHERE discharge_date IS NULL AND email = ?1", nativeQuery = true)
  Users_vo find_user_by_email(String email);

  // First name-----------------------------------------------------------------
  @Query(value = "SELECT * FROM users WHERE discharge_date IS NULL AND first_name = ?1", nativeQuery = true)
  Users_vo find_user_by_First_name(String first_name);

  // last name------------------------------------------------------------------
  @Query(value = "SELECT * FROM users WHERE discharge_date IS NULL AND last_name = ?1", nativeQuery = true)
  Users_vo find_user_by_last_name(String last_name);

  // auth0 id------------------------------------------------------------------
  @Query(value = "SELECT * FROM users WHERE discharge_date IS NULL AND auth0_id = ?1", nativeQuery = true)
  Users_vo find_auth0_id(String auth0_id);
  ...
  @Query(value = "SELECT * FROM users " +
      ...
      "OR email LIKE %:filter_value%", nativeQuery = true)
  ...
  @Query(value = "SELECT * FROM users " +
      "WHERE " +
      "discharge_date IS NULL " +
      "AND email LIKE %:filter_value%", nativeQuery = true)
  ...
  @Query(value = "SELECT * FROM users " +
      "WHERE " +
      "discharge_date IS NULL " +
      "AND first_name LIKE %:filter_value% ", nativeQuery = true)
  ...
  @Query(value = "SELECT * FROM users " +
      "WHERE " +
      "discharge_date IS NULL " +
      "AND last_name LIKE %:filter_value%", nativeQuery = true)
  ...
  // ID-------------------------------------------------------------------------
  @Query(value = "SELECT * FROM users WHERE discharge_date IS NULL AND id = ?1", nativeQuery = true)
